...
# xml文件路径
cur_path = os.getcwd()
path = os.path.join(cur_path, "Z:\\CodeSaving\\Pycharm\\DL_AT3\\DL_AT3_Data\\AfterScreened\\YOLOM2\\Annotations\\training\\"
)

txt_dir = os.path.join(cur_path, "Z:\\CodeSaving\\Pycharm\\DL_AT3\\DL_AT3_Data\\AfterScreened\\YOLOM2\\Annotations\\training_txt\\"
)
...
def single_xml_to_txt(xml_file):
    ...
    root = tree.getroot()
    # 保存的txt文件路径
    txt_file = txt_dir + xml_file[-10:-4] + '.txt'
